...
const brands: Brand[] = [
  { name: 'YKK AP', sub: 'Standard Dunia', hoverColor: 'group-hover:text-blue-600', tracking: 'tracking-tighter' },
  { name: 'Alexindo', sub: 'Profil Alumunium', hoverColor: 'group-hover:text-slate-950', tracking: 'tracking-[0.1em]' },
  { name: 'Forta', sub: 'Hardware System', hoverColor: 'group-hover:text-red-600', tracking: 'tracking-tighter' },
  { name: 'Inkalum', sub: 'Inovasi Alumunium', hoverColor: 'group-hover:text-green-700', isItalic: true },
  { name: 'Dacon', sub: 'Precision Profile', hoverColor: 'group-hover:text-orange-600', tracking: 'tracking-widest' },
  { name: 'Alcopan', sub: 'Premium ACP', hoverColor: 'group-hover:text-sky-500', tracking: 'tracking-tight' },
  { name: 'Seven', sub: 'ACP Specialist', hoverColor: 'group-hover:text-yellow-600', tracking: 'tracking-[0.2em]' },
];
          ...
          {brands.map((brand, index) => (
            ...
            >
              <div className="h-8 flex flex-col justify-center">
                <span className={`text-xl font-black text-slate-800 transition-colors duration-300 ${brand.hoverColor} ${brand.isItalic ? 'italic' : ''} ${brand.tracking || ''}`}>
                  {brand.name === 'YKK AP' ? (
